	...
	public NetworkResponse performRequest(Request<?> request) throws VolleyError {
		...
		while (true) {
			...
			try {
				...
				String charset = request.getDefaultCharset();
				charset = charset == null ? parseCharset(httpResponse) : charset;
				return new NetworkResponse(statusCode, responseContents, charset);
