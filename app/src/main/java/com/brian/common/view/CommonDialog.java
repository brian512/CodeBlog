...
public class CommonDialog extends BaseDialog {
    ...
    private void initUI() {
        ...
        View dlgView = LayoutInflater.from(mContext).inflate(R.layout.dialog_common, null);

        mTitle      = (TextView) dlgView.findViewById(R.id.dlg_title);
        mContent    = (TextView) dlgView.findViewById(R.id.dlg_content);
        mContentEx  = (TextView) dlgView.findViewById(R.id.dlg_content_ex);
        mContentEdit= (EditText) dlgView.findViewById(R.id.dlg_edit_text);
        mLeftBtn    = (TextView) dlgView.findViewById(R.id.dlg_left_btn);
        mRightBtn   = (TextView) dlgView.findViewById(R.id.dlg_right_btn);
        mBtnSplit   = (ImageView)dlgView.findViewById(R.id.dlg_btn_split);
        ...
        setPositiveBtnListener(listener);
        setNegativeBtnListener(listener);
